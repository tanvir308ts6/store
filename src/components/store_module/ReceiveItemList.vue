    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <button id="add_item_button" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Receive Item
                </button>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(itemReceive, index) in itemReceived" :key="index">
                                                                        ...
                                                                        <th scope="row">{{index+1}}</th>
                                                                        <td v-for="(letestItem,index) in itemReceive.item_details" :key="index" class="list-group-item">
                                                                          {{letestItem?.item?.item_name}} 
                                                                        </td>
                                                                        <td>{{letestItem?.item?.item_code}}</td>
